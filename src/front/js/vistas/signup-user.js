      ...
      <div className="container-form">
        ...
        <form className="form" onSubmit={handleSubmit}>
          <div className="container-inputs">
            <input type="name" className="form-control" name="full name" id="exampleInputEmail1" placeholder="Nombre Completo" aria-describedby="emailHelp" value={register.full_name} onChange={(e) => setRegister({ ...register, full_name: e.target.value })} />
            ...
            <input type="Password" className="form-control" name="Password" id="exampleInputEmail1" placeholder="Contraseña" aria-describedby="emailHelp" value={register.password} onChange={(e) => setRegister({ ...register, password: e.target.value })} />
          </div>
