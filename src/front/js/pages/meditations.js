	...
	return (
		<div className="container-fluid">
			<div className="introduction_meditations">
				...
				<div className="explicacion_meditations"><strong>Nuestro equipo de colabores ha seleccionado estos videos de meditaciones para ti. Esperamos que te ayuden a integrar tu mente y tu cuerpo.</strong></div> 
			</div>
